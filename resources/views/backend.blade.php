    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          @foreach ($data as $data )   
          <li class="nav-item menu-items"  {{count($data->subCategories )> 0 ? 'menu-arrow':''}}>
            <a class="nav-link" data-toggle="collapse" href="#ui-basic{{$data->id}}" aria-expanded="false" aria-controls="ui-basic">
              <span class="menu-icon">
              ...
              @foreach ($data->subcategories as $cat)
            <div class="collapse" id="ui-basic{{$data->id}}">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{$data->name.$cat->id}}">{{$cat->name}}</a></li>
              </ul>
            </div>
            @endforeach
            @else
